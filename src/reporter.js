...
import { printScriptsConsole, buildScriptsHtml, SCRIPTS_CSS } from './script-analyzer.js';
...
function buildHtml(results) {
  ...
  const blocks = results.map((r) => {
    ...
    const scriptsBlock = buildScriptsHtml(r);
...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .timeout-warning { color: #a06000; background: #fff8e1; border: 1px solid #ffe082; border-radius: 4px; padding: 6px 10px; margin: 8px 0; font-size: 13px; }${SCRIPTS_CSS}
  </style>
</head>
<body>
